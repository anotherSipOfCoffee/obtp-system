...
function render(){
 scene=api.geometry($('joint').value,{cutaway:false,revision:$('revision').value});const d=scene.detail,p=d.product;
...
for(const id of ['joint','revision'])$(id).onchange=render;
