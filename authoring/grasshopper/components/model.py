...
try:
    ...
    p=core.parameters(int(preset_index),bool(custom),
        studio_winter_closed=studio_winter_closed,program_type=program_type,system_type=system_type,roof_type=roof_type,terrace_steps=terrace_steps,window_width=window_width,facade_type=facade_type,
