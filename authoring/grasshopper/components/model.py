...
try:
    ...
    for _input in ['preset_index','room_depth_steps','sauna_length_steps','hall_length_steps',
                   'roof_type','terrace_steps','window_width','facade_type','storage_length_steps','wall_height','partition_depth','door_width','door_height',
    ...
    p=core.parameters(int(preset_index),bool(custom),
        roof_type=roof_type,terrace_steps=terrace_steps,window_width=window_width,facade_type=facade_type,
