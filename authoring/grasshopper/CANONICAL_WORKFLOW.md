...
R07: owner authorized Studio preset implementation and publication after research/validation on 2026-09-26. `program_type=0/1` selects Sauna/Studio in the same core; no separate structural generator. Studio is non-residential creative work + preparation/storage + open covered centre. Wind/snow remain paused. Prior infrastructure-planning pause is superseded for this scoped release only.

Object library R01: read OBJECT_LIBRARY_R01.md. obtp/object_library.py supplies linked door geometry/symbol identity and existing-object placeholder records. Keep product interfaces and structural host framing distinct.
